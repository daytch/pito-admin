                ...
                <div className="w-full xl:w-4/5">
                    <form>
                        <div className="flex flex-wrap w-full items-start">
                            ...
                            <input type="text" placeholder="Title" maxLength="60" value={title} onChange={titleChange} className="w-full md:w-2/5 px-4 py-2 my-2 md:my-0 md:ml-4 border border-gray-300 rounded-lg" />
                        </div>
                        <div className="flex flex-wrap w-full items-start mt-4">
                            ...
                            <textarea placeholder="Description" maxLength="2000" value={desc} onChange={descChange} className="w-full md:w-2/5 h-32 px-4 py-2 md:ml-4 my-2 md:my-0 border border-gray-300 rounded-lg" />
                        </div>
